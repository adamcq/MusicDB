...
ALTER TABLE additional_contact_person ADD CONSTRAINT PK_additional_contact_person PRIMARY KEY (person_id_student);
...
CREATE TABLE ensemble (
 ...
 time TIME NOT NULL,
 date DATE NOT NULL,
 person_id_instructor INT NOT NULL,
...
ALTER TABLE instructor_instrument ADD CONSTRAINT PK_instructor_instrument PRIMARY KEY (instrument_id,person_id_instructor);
...
CREATE TABLE sibling_relationship (
 first_person_id_student INT NOT NULL,
 second_person_id_student INT NOT NULL
);

ALTER TABLE sibling_relationship ADD CONSTRAINT PK_sibling_relationship PRIMARY KEY (first_person_id_student,second_person_id_student);
...
ALTER TABLE student_ensemble ADD CONSTRAINT PK_student_ensemble PRIMARY KEY (ensemble_id,person_id_student);
...
ALTER TABLE student_group_lesson ADD CONSTRAINT PK_student_group_lesson PRIMARY KEY (group_lesson_id,person_id_student);


ALTER TABLE additional_contact_person ADD CONSTRAINT FK_additional_contact_person_0 FOREIGN KEY (person_id_student) REFERENCES student (person_id);


ALTER TABLE ensemble ADD CONSTRAINT FK_ensemble_0 FOREIGN KEY (person_id_instructor) REFERENCES instructor (person_id);
...
ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_0 FOREIGN KEY (person_id_instructor) REFERENCES instructor (person_id);
...
ALTER TABLE individual_lesson ADD CONSTRAINT FK_individual_lesson_0 FOREIGN KEY (person_id_instructor) REFERENCES instructor (person_id);
ALTER TABLE individual_lesson ADD CONSTRAINT FK_individual_lesson_1 FOREIGN KEY (person_id_student) REFERENCES student (person_id);
...
ALTER TABLE instructor_instrument ADD CONSTRAINT FK_instructor_instrument_1 FOREIGN KEY (person_id_instructor) REFERENCES instructor (person_id) ON DELETE CASCADE;
...
ALTER TABLE rental_agreement ADD CONSTRAINT FK_rental_agreement_0 FOREIGN KEY (person_id_student) REFERENCES student (person_id);
...
ALTER TABLE sibling_relationship ADD CONSTRAINT FK_sibling_relationship_0 FOREIGN KEY (first_person_id_student) REFERENCES student (person_id);
ALTER TABLE sibling_relationship ADD CONSTRAINT FK_sibling_relationship_1 FOREIGN KEY (second_person_id_student) REFERENCES student (person_id);
...
ALTER TABLE student_ensemble ADD CONSTRAINT FK_student_ensemble_1 FOREIGN KEY (person_id_student) REFERENCES student (person_id) ON DELETE CASCADE;
...
ALTER TABLE student_group_lesson ADD CONSTRAINT FK_student_group_lesson_1 FOREIGN KEY (person_id_student) REFERENCES student (person_id) ON DELETE CASCADE;
